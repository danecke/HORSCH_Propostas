...
function QuotesView({ quotes, me, onChanged }: { quotes: Quote[]; me: CurrentAccess; onChanged: () => Promise<void> }) {
  ...
  return <div className="content-frame"><header className="page-heading"><div><span className="eyebrow">Fluxo de atendimento</span><h1>Cotações</h1><p>Concessionária solicita → Gestão Global responde → Concessionária aprova ou reprova → Gestor Fábrica coloca o pedido.</p></div></header>
