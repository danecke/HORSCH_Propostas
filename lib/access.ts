...
export function rolePermissions(role: UserRole) {
  return {
    ...
    viewPriceList: true,
    requestQuote: ["dealer_manager", "concession"].includes(role),
    respondQuote: ["general_admin", "global_management"].includes(role),
    requestProposal: role === "dealer_manager",
    ...
    viewOpenQuotes: ["general_admin", "global_management", "factory_manager", "dealer_manager", "concession"].includes(role),
    approveQuoteReturn: ["general_admin", "dealer_manager", "concession"].includes(role),
    ...
    editAnyProposal: ["general_admin", "global_management"].includes(role),
