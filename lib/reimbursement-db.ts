...
const TABLE_STATEMENTS = [
  ...
  "CREATE TABLE IF NOT EXISTS reimbursement_settings (setting_key TEXT PRIMARY KEY, numeric_value INTEGER NOT NULL, updated_by_email TEXT NOT NULL DEFAULT 'system', updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP)",
